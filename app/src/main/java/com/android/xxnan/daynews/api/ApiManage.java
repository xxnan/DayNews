...
import com.android.xxnan.daynews.MyAppliction;
import com.android.xxnan.daynews.utils.NetWorkUtil;
...
public class ApiManage {
    ...
    private static final Interceptor REWRITE_CACHE_CONTROL_INTERCEPTOR = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (NetWorkUtil.isNetWorkAvailable(MyAppliction.getApplictionContext())) {
    ...
    private static File httpCacheDirectory = new File(MyAppliction.getApplictionContext().getCacheDir(), "zhihuCache");
